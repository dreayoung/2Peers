    ...
    .end((err, res) => {
      ...
      expect(res.body).toStrictEqual({
        user: {
          ...
          name: 'Test',
          email: 'Test@gmail.com',
          profile: 'https://i.pinimg.com/originals/56/b4/9f/56b49f8fe357deecf54ad7805209d79e.png',
          subject: null,
    ...
    .end((err, res) => {
      ...
      expect(res.body).toStrictEqual({
        user: {
          ...
          name: 'Test',
          email: 'Test@gmail.com',
          profile: 'https://www.pngitem.com/pimgs/m/77-778738_transparent-indian-elephant-png-cartoon-elephant-side-view.png',
          encryptedpassword: res.body.user.encryptedpassword,
          archived: false,
          created_at: null,
          updated_at: null,
