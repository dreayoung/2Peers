                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div onChange={(e) => { setEmail(e.target.value); }}>
                      Input email goes here
                    </div>
                    <div>
                      <input id="name" name="name" type="text" className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" onChange={(e) => { setName(e.target.value); }} />
                    </div>
                  </div>
                </div>
