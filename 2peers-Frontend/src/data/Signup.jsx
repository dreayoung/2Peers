      ...
      <div data-testid="signup-form" className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 data-testid="signup-heading" className="mt-6 text-center text-3xl font-extrabold text-gray-900">
              Sign Up
            </h2>
            <p data-testid="signup-subheading" className="mt-2 text-center text-sm text-gray-600">
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <label data-testid="teacher-label" htmlFor="checkbox" className="ml-2 block text-sm text-gray-900">
                  <input data-testid="teacher-box" id="checkbox" name="checkbox" type="checkbox" checked={checkbox} onChange={() => { setCheck((prev) => !prev); }} className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
                  Are you a teacher?
                </label>
              </div>
            </div>
